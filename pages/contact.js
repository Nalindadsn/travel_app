...
<div></div><br/>
  ...
  <div>
  <div>                                       </div>                      <img style={{width:"50%",float:"left"}} src="https://res.cloudinary.com/masterdevs/image/upload/v1686134248/feature1_afvlur.png"/>

             <h1 className="mb-4 text-center text-4xl font-extrabold leading-none tracking-tight text-gray-900 md:text-5xl lg:text-6xl dark:text-white">Contact Us</h1>
